    ...
    return (
        <>
            ...
            <input
                    ...
                    defaultValue={stats.location} // Change defaultValue to value
                />
            ...
            <div className="text-center mt-8 text-white "><h1 className="text-[35px]">{stats.location}</h1></div>


            <div className="flex justify-center">
                <div className=" mt mr-6">
                {stats.isDay !== 0 ? (
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        ...
                        strokeWidth={1.5}
                        stroke="currentColor"
                        className="w-14 h-14 text-yellow-300 mt-6"
                    >
                        <path
                            strokeLinecap="round"
                            strokeLinejoin="round"
                    ...
                    <svg
                        ...
                        strokeWidth={1.5}
                        stroke="currentColor"
                        className="w-12 h-12 text-slate-200 mt-6"
                    >
                        <path
                            strokeLinecap="round"
                            strokeLinejoin="round"
            ...
            <div className="flex justify-center text-slate-300 mt-6 text-[25px] ">
                {stats.condition}
            </div>
